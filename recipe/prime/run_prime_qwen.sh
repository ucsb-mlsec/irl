...
claude_train_path=$HOME/irl/data/train_5000_processed.parquet
...
python3 -m recipe.prime.main_prime \
    ...
    trainer.experiment_name='PRIME-Qwen2.5-3B_bs128' \
    trainer.n_gpus_per_node=2 \
    trainer.nnodes=1 \
    trainer.save_freq=64 \
    trainer.test_freq=64 \
    trainer.total_epochs=15 $@ > PRIME-Qwen2.5-3B_bs128.log
